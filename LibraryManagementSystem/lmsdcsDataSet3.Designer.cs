...
SELECT BookID, ISBN, BookTitle, Author, Category, PublishedDate, BookShelves, Quantity, Price, Location, Publisher, ImageFile, Status FROM Inventory WHERE (BookID = @BookID)";
        ...
        public virtual int Fill(lmsdcsDataSet3.InventoryDataTable dataTable) {
        ...
        public virtual lmsdcsDataSet3.InventoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            lmsdcsDataSet3.InventoryDataTable dataTable = new lmsdcsDataSet3.InventoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(lmsdcsDataSet3.InventoryDataTable dataTable) {
